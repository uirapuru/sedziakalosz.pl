...
namespace Dende\KaloszBundle\Controller;
...
use Dende\KaloszBundle\Entity\Movie;
use Dende\KaloszBundle\Form\MovieType;
...
class MovieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('KaloszBundle:Movie')->findAll();
     ...
     * @Method("POST")
     * @Template("KaloszBundle:Movie:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('KaloszBundle:Movie')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("KaloszBundle:Movie:edit.html.twig")
     */
